import { Block, BlockDescription, BlockHeader, BlockHeaderTitle, Button, FlexContainer } from "../components";
...
const ConnectionsSettings = () => {
    ...
    const { data: connectedAccountsData, isLoading, error } = useQuery({
        ...
        select: (data) => {
            console.log(data.data.data.networksData);
            return ([
                {
                    label: "Web",
                    icon: "domain",
    ...
    useEffect(() => {
        console.log(connectedAccountsData, isLoading, error);
    }, [connectedAccountsData, isLoading, error]);
