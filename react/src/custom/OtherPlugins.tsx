    ...
    return (
        <Card variant={"transparent"}>
            ...
            <FlexContainer direction={"column"} className={"!gap-2"}>
                <ListItem icon={"circle"} iconColor={"rss"} link={__("Upgrade", "metricool")} className={"font-semibold"}>
                    {__("Really Simple Security Pro", "metricool")}
                </ListItem>
                <ListItem icon={"circle"} iconColor={"simplybook"} link={__("Install", "metricool")} className={"font-semibold"}>
                    {__("Simplybook: Online booking system", "metricool")}
                </ListItem>
                <ListItem icon={"circle"} iconColor={"complianz"} link={__("Install", "metricool")} className={"font-semibold"}>
