...
/**
 * Forced to implement forwardRef because the render method of {@link ComboboxInput}
 * passes a ref, so we need to catch this here and not pass it further to Input,
 * which doesn't support refs as props because of React v18.3.
 * ref has an underscore prefix to denote to TS that it is meant to be unused.
 */
