...
// Filtering an entity
$response = App::provide('client')->example()->filter([
    'start' => '20230101',
    'end' => '20230131',
])->get();
...
// Updating an entity
$response = App::provide('client')->example()->update([
    'property1' => 'new value',
