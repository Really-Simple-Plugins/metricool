...
//        add_action("admin_print_styles-$pageHookSuffix", [$this, 'enqueueDashboardStyles']);
        ...
        if (file_exists($manifest)) {
            ...
            foreach ($decoded_manifest as $key => $value) {
                ...
                if (!empty($value['css'])) {
                    wp_enqueue_style(
                        'metricool-tailwind',
                        App::env('plugin.react_url') . '/build/' . $value['css'][0],
                        [],
                        null,
                    );
                }
    ...
    private function localizedReactSettings(array $chunkTranslation): array
    {
        return apply_filters(
            ...
            [
                ...
                'trusted_urls' => App::env('frontend.trusted_urls'),
    ...
    public function load_as_module( $tag, $handle ) {
        if (str_contains($handle, 'metricool-main-script')) {
